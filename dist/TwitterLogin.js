...
var TwitterLoginComponent = (function (_super) {
    ...
    function TwitterLoginComponent(props) {
        ...
        _this.handleLoginClick = function () { return __awaiter(_this, void 0, void 0, function () {
            var _a, consumerKey, consumerSecret, callbackUrl, token, obtainRequestTokenConfig, requestTokenData, popup;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        _a = this.props, consumerKey = _a.consumerKey, consumerSecret = _a.consumerSecret, callbackUrl = _a.callbackUrl, token = _a.token;
                        if (callbackUrl) {
